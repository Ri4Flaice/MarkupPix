...
namespace MarkupPix.Data.Migrations
{
    ...
    [Migration("20240623172729_DocumentsTableAddedListPages")]
    partial class DocumentsTableAddedListPages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MarkupPix.Data.Entities.DocumentEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("MarkupPix.Data.Entities.UserEntity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int>("AccountType")
                        .HasColumnType("int")
                        .HasComment("The type of the user's account");

                    b.Property<DateTime>("BirthDate")
                        .HasColumnType("date")
                        .HasComment("The user's birthdate");

                    b.Property<bool>("Block")
                        .HasColumnType("tinyint(1)")
                        .HasComment("Indicates that the user is blocked");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<long>", b =>
                {
                    b.HasOne("MarkupPix.Data.Entities.UserEntity", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
